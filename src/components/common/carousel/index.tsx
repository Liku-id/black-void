...
export function Carousel({
  ...
  return (
    ...
    >
        ...
        {animate ? (
          <>
            ...
            <img
              ...
              alt=""
              className={`absolute h-full w-full object-cover transition-opacity transition-transform duration-500 ${isAnimating && showPrev ? "scale-105" : "scale-100"} opacity-100 cursor-pointer`}
      ...
      <Box className="flex justify-center mt-10 gap-2">
        {images.map((_, index) => (
          <button
            key={index}

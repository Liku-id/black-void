...
describe('Accordion (single element, controlled)', () => {
  ...
  it('renders the question', () => {
    render(<Accordion question={question} answer={answer} open={false} onClick={() => {}} />);
  ...
  it('renders the answer when open', () => {
    render(<Accordion question={question} answer={answer} open={true} onClick={() => {}} />);
    expect(screen.getByText(answer)).toBeVisible();
  });

  it('calls onClick when clicked', () => {
    const handleClick = jest.fn();
    render(<Accordion question={question} answer={answer} open={false} onClick={handleClick} />);

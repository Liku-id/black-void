...
const faqs = [
  { question: 'How do I buy a ticket??', answer: "Simply find the event you want to attend, select your ticket category and quantity, click 'Book Ticket', and proceed to checkout. You’ll receive your e-ticket via email after successful payment." },
  ...
  { question: 'I didn’t receive my ticket email—what should I do?', answer: '' },
  { question: 'What if the event is canceled or rescheduled?', answer: '' },
  { question: 'Can I buy tickets for multiple people in one transaction?', answer: '' },
  ...
  return (
    <section className="bg-white">
      ...
      <Container className='px-4 py-12 md:py-24'>
        ...
        <Box className="flex flex-col xl:flex-row gap-6">
          {/* Left column */}
